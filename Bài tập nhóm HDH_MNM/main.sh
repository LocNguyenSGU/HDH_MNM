...
while true
    do
    	clear
        echo "                                          CHUONG TRINH QUAN LY NHAN VIEN"
        echo "+=====================================================================================================================+"
        ...
        echo "| 4. Liet ke danh sach nhan vien cua don vi x, co nam sinh nho hon y (x,y do nguoi dung nhap vao)                     |"
        echo "| 5. Thong ke danh sach nhan vien co sinh nhat vao thang x (x do nguoi dung nhap vao)                                 |"
        echo "| 6. Liet ke danh sach nhan vien trong ho ten co chu x, gioi tinh y, sinh nam z (x,y,z do nguoi dung nhap vao)        |"
        ...
        # -n 1 : chi doc 1 ki tu
        # -s : khong hiển thị ký tự nhập vào
        # -r : bat ca dau /
